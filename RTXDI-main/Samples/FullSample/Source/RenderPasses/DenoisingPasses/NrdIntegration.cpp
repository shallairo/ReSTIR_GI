...
{
    donut::log::debug("Initializing NRD integration...");
    ...
    layoutDesc0.registerSpaceIsDescriptorSet = true;
    ...
    for (uint32_t pipelineIndex = 0; pipelineIndex < instanceDesc.pipelinesNum; pipelineIndex++)
    {
        ...
        layoutDesc1.registerSpaceIsDescriptorSet = true;
    ...
    float debug)
{
    ...
    commonSettings.splitScreen = debugSettings.splitScreen;
    ...
    commonSettings.enableValidation = debugSettings.enableValidation;
        ...
        for (uint32_t resourceRangeIndex = 0; resourceRangeIndex < nrdPipelineDesc.resourceRangesNum; resourceRangeIndex++)
        {
            ...
            for (uint32_t descriptorOffset = 0; descriptorOffset < nrdDescriptorRange.descriptorsNum; descriptorOffset++)
            {
                ...
                case nrd::ResourceType::IN_MV:
                    if (enablePsr)
                        texture = renderTargets.PSRMotionVectors;
                    else
                        texture = renderTargets.MotionVectors;
                    break;
                case nrd::ResourceType::IN_NORMAL_ROUGHNESS:
                    if (enablePsr)
                        texture = renderTargets.PSRNormalRoughness;
                    else
                        texture = renderTargets.NormalRoughness;
                    break;
                case nrd::ResourceType::IN_VIEWZ:
                    if (enablePsr)
                        texture = renderTargets.PSRDepth;
                    else
                ...
                case nrd::ResourceType::OUT_VALIDATION:
                    texture = renderTargets.NrdValidation;
                    break;
